...
while True:
    ...
    try:
        ...
        os.remove('/home/pictor/Desktop/pictortelescope/data_freq.csv')
        os.remove('/home/pictor/Desktop/pictortelescope/data_time.csv')
    except OSError:
        pass
...
Your observation's averaged spectrum, dynamic spectrum (waterfall) and Power vs Time plot are attached in this email as an image.'''
        ...
        filename1 = 'plot.png'
        attachment1 = open("/home/pictor/Desktop/pictortelescope/"+filename1, 'rb')
        ...
        if (raw_data == '1'):
            ...
            attachment4 = open("/home/pictor/Desktop/pictortelescope/"+filename4, 'rb')
